          ...
          >
            <Card className="bg-white border-none shadow-lg rounded-xl p-5">
              ...
              <div className="grid grid-cols-2 gap-3">
                {/* Pomodoros */}
                <div className="bg-gradient-to-br from-[#E6FAF4] to-white rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="w-8 h-8 rounded-lg bg-[#20C997]/10 flex items-center justify-center">
                      <Clock className="w-4 h-4 text-[#20C997]" />
                    </div>
                  </div>
                  <p className="text-2xl text-[#495057] mb-1">25</p>
                  <p className="text-xs text-[#495057]/60">Pomodoros</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-[#E6FAF4] to-white rounded-xl p-4">
                  ...
                  <p className="text-2xl text-[#495057] mb-1">50</p>
                  <p className="text-xs text-[#495057]/60">Flashcards</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-[#E6FAF4] to-white rounded-xl p-4">
                  ...
                  <p className="text-2xl text-[#495057] mb-1">{diagnoses.length}</p>
                  <p className="text-xs text-[#495057]/60">Diagnósticos</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-[#E6FAF4] to-white rounded-xl p-4">
                  ...
                  <p className="text-2xl text-[#495057] mb-1">12</p>
                  <p className="text-xs text-[#495057]/60">Sessões</p>
                </div>
              </div>
            </Card>
          </motion.div>
